...
/* harmony import */ var _modules_funcs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/funcs */ "./src/modules/funcs.js");
...
window.addEventListener("load", () => {
    ...
    for (let i = 0; i < projects.length; i++) {
        ...
        project.addTask = _modules_project__WEBPACK_IMPORTED_MODULE_1__.Project.prototype.addTask;
        project.removeTask = _modules_project__WEBPACK_IMPORTED_MODULE_1__.Project.prototype.removeTask;
        (0,_modules_funcs__WEBPACK_IMPORTED_MODULE_2__.addProject)(project);
        const projectDiv = document.querySelector(".projects div:last-child");
        projectDiv.addEventListener("click", () => {
            currentProject = project;
            (0,_modules_project__WEBPACK_IMPORTED_MODULE_1__.loadProject)(projects[projects.indexOf(currentProject)]);
        });
        ...
        projectDiv.addEventListener("dblclick", (e) => {
            ...
            (0,_modules_project__WEBPACK_IMPORTED_MODULE_1__.loadProject)(projects[0]);
            (0,_modules_funcs__WEBPACK_IMPORTED_MODULE_2__.updateStorage)()
        });
    }
...
addProjectBtn.addEventListener("click", () => {
    ...
    const project = new _modules_project__WEBPACK_IMPORTED_MODULE_1__.Project(projectName.value)
    ;(0,_modules_funcs__WEBPACK_IMPORTED_MODULE_2__.addProject)(project);
    const projectDiv = document.querySelector(".projects div:last-child");
...
addTaskBtn.addEventListener("click", () => {
    ...
    const task = (0,_modules_funcs__WEBPACK_IMPORTED_MODULE_2__.addTask)(title.value, description.value, date.value);
    projects[projects.indexOf(currentProject)].addTask(task);
    (0,_modules_funcs__WEBPACK_IMPORTED_MODULE_2__.updateStorage)()
    ;(0,_modules_funcs__WEBPACK_IMPORTED_MODULE_2__.removeTask)(task)
